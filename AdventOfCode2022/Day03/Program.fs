module AdventOfCode2022.Day03.Program
...
let main argv =
    ...
    timer.Stop ()
    let part2Duration = timer.ElapsedMilliseconds - part1Duration
    printfn $"Part 2: %d{resultPart2} (execution took %i{part2Duration} ms)"
